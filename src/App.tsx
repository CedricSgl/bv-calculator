...
const produits: Produit[] = [
  ...
  { id: 3, nom: 'Placebo (Lupulus)', prix: 3.5 },
  {
    id: 4,
    nom: /*"Lupulus Fructus/Taras/Chaumontoise/WunderLager"*/ 'Bières Légères',
    prix: 3.5
  },
  { id: 5, nom: 'Autres Bières', prix: 4 },
  { id: 6, nom: 'Grandes Bières', prix: 9 },

  { id: 7, nom: 'Verre de vin', prix: 3 },
  ...
  { id: 17, nom: 'Croque-Monsieur', prix: 7 },
    ...
    <MantineProvider>
      ...
      >
          ...
          {produits.map((produit, index) => (
            ...
            >
              ...
              <Flex gap='xs' align='center' justify='flex-end'>
                ...
                <Button
                  variant='default'
                  onClick={() => ajusterQuantite(index, -1)}
                >
                  -
                </Button>
        ...
        <AppShell.Footer>
          <Group
            justify='space-between'
            style={{ marginBottom: 10, marginTop: 10, margin: 10 }}
          >
            <Group>
              <Input
                placeholder='Total du compte'
                value={value}
                type='Number'
            ...
            <Group>
              <Text size='lg' c={solde() < 0 ? 'red' : 'inherit'}>
                Solde : {solde()} €
              </Text>
            </Group>
          </Group>
